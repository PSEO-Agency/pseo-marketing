        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {tags.map((tag: string, i: number) => (
              <span
                key={i}
                className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm"
              >
...
export const PartnerProof = ({ partner }: { partner: Partner }) => {
  const metrics = Array.isArray(partner.case_study_metrics)
    ? partner.case_study_metrics
    : [];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {metrics.map((m: any, i: number) => (
              <div
                key={i}
                className="text-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100"
              >
  ...
  <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white">
    <div className="container mx-auto px-6 text-center">
      ...
      <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
        Combine local expertise with our proven programmatic SEO methodology for
