  ...
  const filtered = useMemo(() => {
    ...
    return partners.filter((p) => {
      ...
      if (
        ...
        return false;
      if (filters.types.length && !filters.types.includes(p.partner_type))
        return false;
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto">
              Our global network of trusted partners helps companies scale SEO
              growth through automation, AI content, integrations, and local
              execution.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                ...
                onClick={() =>
                  document
                    .getElementById("partner-grid")
                    ?.scrollIntoView({ behavior: "smooth" })
                }
              >
                Browse Partners <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
              <Link href="/agency/partners/apply">
                <Button
                  variant="outline"
