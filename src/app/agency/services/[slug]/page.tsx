  ...
  return [
    {
      ...
      description:
        "We analyze your current situation and identify opportunities for improvement.",
    },
    {
      title: "Strategy Development",
      description:
        "We create a customized strategy tailored to your specific needs and goals.",
    },
    {
    ...
    },
    {
      ...
      description:
        "We continuously optimize and track results to maximize your ROI.",
    },
  ];
}
  ...
  const faqs = [
    {
      ...
      answer:
        "Most clients see initial improvements within 30-60 days, with significant results typically visible within 3-6 months. The exact timeline depends on your current situation and industry competitiveness.",
    },
    {
      question: `What makes your ${service.title} different from competitors?`,
      answer:
        "Our approach combines cutting-edge technology with proven strategies, personalized attention, and transparent reporting. We focus on delivering measurable ROI rather than just vanity metrics.",
    },
    {
      question: "Do you offer ongoing support after implementation?",
      answer:
        "Yes, we provide comprehensive ongoing support including regular monitoring, optimization, monthly reports, and strategic adjustments to ensure continued success.",
    },
    {
      question: "What kind of businesses benefit most from this service?",
      answer:
        "Our service works well for businesses of all sizes, from startups to enterprise companies. We customize our approach based on your specific industry, goals, and budget.",
    },
    {
      question: "How do you measure success?",
      answer:
        "We track key performance indicators relevant to your goals, including traffic growth, conversion rates, revenue impact, and ROI. You'll receive detailed monthly reports with actionable insights.",
    },
    {
      question: "What's included in your service package?",
      answer:
        "Our service includes strategy development, implementation, ongoing optimization, regular reporting, dedicated account management, and 24/7 support access.",
    },
  ];
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div
              className="absolute bottom-10 right-10 w-48 h-48 lg:w-80 lg:h-80 bg-purple-500/20 rounded-full blur-3xl animate-pulse"
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
              <div className="max-w-3xl">
                ...
                <p className="text-base sm:text-lg lg:text-xl text-blue-100 mb-3 sm:mb-4 lg:mb-6 leading-relaxed max-w-2xl">
                  {service.description ||
                    `Scale your organic traffic exponentially with our data-driven ${service.title} strategies. We create thousands of high-converting pages that rank on page 1 and drive qualified leads to your business.`}
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-3 sm:mb-4 lg:mb-6">
                  {[
                    ...
                    <div
                      key={text}
                      className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-1.5 sm:py-2 border border-white/20"
                    >
              ...
              <div className="relative">
                <div className="text-center mb-4 sm:mb-6 lg:mb-8">
                  <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-2 sm:mb-3 text-balance">
                    Our Proven Process
                  </h3>
                ...
                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                  {processSteps.slice(0, 4).map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br ${stepColors[index] || stepColors[0]} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl relative`}
                        >
                          <IconComponent className="h-4 w-4 sm:h-5 sm:w-5 lg:h-8 lg:w-8 text-white" />
                          <div className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 w-4 h-4 sm:w-5 sm:h-5 bg-green-400 rounded-full flex items-center justify-center text-xs font-bold text-green-900">
                            {index + 1}
                          </div>
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="bg-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-lg">
                            <h4 className="font-bold text-gray-900 mb-1 sm:mb-2 text-base sm:text-lg lg:text-xl">
                              {step.title}
                            </h4>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${colors[index % colors.length]} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-all duration-300`}
                    >
                  ...
                  {[
                    {
                      ...
                      text: "Track record of delivering measurable improvements",
                    },
                    {
                      icon: Users,
                      color: "from-blue-500 to-blue-600",
                      title: "Expert Team",
                      text: "Dedicated specialists with years of experience",
                    },
                    {
                      icon: Target,
                      color: "from-purple-500 to-purple-600",
                      title: "Custom Approach",
                      text: "Tailored strategies for your specific goals",
                    },
                  ].map((item, i) => (
              ...
              <div className="space-y-8">
                {processSteps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex-shrink-0 w-16 h-16 bg-gradient-to-br ${stepColors[index % stepColors.length]} rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-all duration-300 transform group-hover:scale-110 relative`}
                      >
                        <IconComponent className="h-8 w-8 text-white" />
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      },
                      {
                        label: "Success Rate:",
                        value: "95%+",
                        cls: "text-green-600 text-xl",
                      },
                    ].map((row, i) => (
                      <div
                        key={i}
                        className={`flex items-center justify-between py-3 ${i < 3 ? "border-b border-gray-100" : ""}`}
                      >
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-12 leading-relaxed max-w-3xl mx-auto">
                Join thousands of businesses that have achieved remarkable
                growth with our expert {service.title.toLowerCase()} service.
              </p>
